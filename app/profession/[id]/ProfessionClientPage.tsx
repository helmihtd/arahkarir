...
export default function ProfessionClientPage({ params }: { params: { id: string } }) {
  useEffect(() => {
    // Add smooth scrolling behavior
              ...
              <div className="sticky top-20">
                <nav className="bg-white rounded-lg border border-gray-200 p-4">
                  ...
                  <ul className="space-y-2">
                    <li>
                      <a href="#about" className="text-indigo-600 hover:text-indigo-800 flex items-center py-1">
                        About This Profession
                      </a>
                    </li>
                    <li>
                      <a href="#education" className="text-gray-700 hover:text-indigo-600 flex items-center py-1">
                        Education Requirements
                      </a>
                    </li>
                    <li>
                      <a href="#skills" className="text-gray-700 hover:text-indigo-600 flex items-center py-1">
                        Skills & Tools
                      </a>
                    </li>
                    <li>
                      <a href="#career-path" className="text-gray-700 hover:text-indigo-600 flex items-center py-1">
                        Career Path
                      </a>
                    </li>
                    <li>
                      <a
                        href="#alternative-paths"
                        className="text-gray-700 hover:text-indigo-600 flex items-center py-1"
                      >
                        Alternative Career Paths
                      </a>
                    </li>
                    <li>
                      <a href="#salary" className="text-gray-700 hover:text-indigo-600 flex items-center py-1">
                        Salary Information
                      </a>
                    </li>
                    <li>
                      <a href="#certifications" className="text-gray-700 hover:text-indigo-600 flex items-center py-1">
                        Recommended Certifications
                      </a>
                    </li>
                    <li>
                      <a href="#people" className="text-gray-700 hover:text-indigo-600 flex items-center py-1">
                        People to Follow
                      </a>
                    </li>
                    <li>
                      <a href="#companies" className="text-gray-700 hover:text-indigo-600 flex items-center py-1">
                        Related Companies
                      </a>
                    </li>
                    <li>
                      <a href="#similar" className="text-gray-700 hover:text-indigo-600 flex items-center py-1">
                        Similar Professions
                      </a>
                    </li>
                  </ul>
